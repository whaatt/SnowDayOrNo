<?php
	...
	$ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, "http://www.wral.com/weather/closings/?category=all&filter=r");
	...
	if (strpos($data, "<td data-title=\"Organization\">Raleigh Charter High School</td>\n                    <td data-title=\"Status\">Closed") !== False){
	...
	else if (strpos($data, "<td data-title=\"Organization\">Raleigh Charter High School</td>\n                    <td data-title=\"Status\">Delayed") !== False){
	...
	else if (strpos($data, "<td data-title=\"Organization\">Raleigh Charter High School</td>") !== False){
...
<html>
	...
	<body>
		<div id="middle">
			...
			<p><a href="http://www.raleighcharterhs.org"><? echo $dateOut; ?></a><br>
